			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 animate-box text-center">
						<h2 class="intro-heading"> <?php
				 	$sql="SELECT * FROM usuarios WHERE id='$_GET[id]'";
					
						$q=mysqli_query($conex,$sql);
						$ver=mysqli_fetch_array($q);			
						echo "Galeria de: ".$ver[1];
...
<?php 
	$sql1="SELECT * FROM fotos where id_usuario='$_GET[id]'";
	...
	$sql="SELECT * FROM fotos where id_usuario='$_GET[id]' order by id desc limit $ini,12";
	$q=mysqli_query($conex,$sql);
	while ($ver=mysqli_fetch_array($q)) { ?>
		...
		<<div id="numeritos" align="center">
			<?php for ($i=1; $i<=$pag ; $i++) { ?>
				<a href="galeria.php?va=<?php echo $i; ?>">
			<?php echo $i." ";?> </a>
			<?php } ?> 
		</div>
		</div>
