...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<div id="fh5co-page">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 animate-box text-center">
						<h2 class="intro-heading"> <?php if (@$_SESSION['quien']>0){ print "Configuracion de cuenta"; } ?> </h2>
		...
		<div id="fh5co-photos-section">
			...
			<h2 align="center">Cuenta de: <?php print $_SESSION['nombre']; ?></h2>
					...
					<?php
					$sql="SELECT * FROM usuarios where id=$_SESSION[quien]";
					...
					while ($ver=mysqli_fetch_array($q)) { ?>		
						<tr>
							...
							<td><input type="password" name="password" value="<?php echo $ver[4]; ?>"></td>						
						</tr>
					</table>

					<table align="center">
						<tr>
							<td><a href="modi.php?mod=<?php echo $ver[0];?>">modificar</a>&nbsp;</td>	
							<td><a href="eliminar.php?eli=<?php echo $ver[0];?>">eliminar</a></td>
						</tr>	
					</table>
						<?php } ?>
