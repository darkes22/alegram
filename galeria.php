			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 animate-box text-center">
						<h2 class="intro-heading"> <?php if (@$_SESSION['quien']>0){ print "Galeria de: " .@$_SESSION['nombre'];} ?> </h2>
...
<?php 
	...
	$sql="SELECT * FROM fotos where id_usuario=$_SESSION[quien] order by id desc limit $ini,12";
