			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 animate-box text-center">
						<h2 class="intro-heading"> <?php if (@$_SESSION['quien']>0){ print "¿Quieres boras tus fotos?"; } ?> </h2>
			...
			<h2 align="center">Fotos de: <?php print $_SESSION['nombre']; ?></h2>
					...
					while ($ver=mysqli_fetch_array($q)) { ?>		
						<tr>
							...
							<td align="center"><a href="eli.php?eli=<?php echo $ver[0];?>">X</a></td>
						</tr> 
						<?php } ?>
					</table>
						...
						<?php for ($i=1; $i<=$pag ; $i++) { ?>
							<a href="eliminarfoto.php?va=<?php echo $i; ?>">
						<?php echo $i." ";?> </a>
						<?php } ?> 
					</div>	
