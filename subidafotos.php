		...
		<div class="js-fullheight fh5co-table">
			<div class="fh5co-table-cell js-fullheight">
				<ul>
					...
					<?php if (@$_SESSION['quien']>0){?>
				<?php } else { ?>
						<li><a href="xHTML/login.php">Login</a></li>
					<?php } ?>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 animate-box text-center">
						<h2 class="intro-heading"> <?php if (@$_SESSION['quien']>0)
						{
							print $_SESSION['nombre'].", ¿Quieres subir fotos?";
						} ?> </h2>
				...
				<div id="ri-grid" class="ri-grid animate-box">
					...
					<div id="wrapper">
							...
							<div id="wrappermiddle">
								...
								<div align="center" >
									<form id="f13" name="f3" method="post" action="subida.php" enctype="multipart/form-data">
										<input type="hidden" name="usuario" value="<?php echo $_GET['id_u']; ?>">
