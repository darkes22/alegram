...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<div id="wrapper">
		...
		<div id="wrappermiddle">
			...
			<div align="center">
							<?php $sql="SELECT * FROM fotos where id='$_GET[edi]'"; 
								$query=mysqli_query($conex,$sql);
								$ver=mysqli_fetch_array($query);			
		 					?>

				<form id="formulario" name="f1"	method="post" action="edi2.php">
					<table>
						<input type="hidden" name="oculto" value="<?php echo $ver[0];?>">
						<tr>
							<td><label for="nombre">titulo:</label></td>
			 				<td><input type="text" name="titulo" value="<?php echo $ver[2];?>" id="titulo" required></td>
						</tr>
						<tr>
							<td><label for="clave">Descripcion:</label></td>
			  					<td><textarea id="descipcion" name="descripcion" required> <?php echo $ver[3]; ?></textarea></td>
						</tr>
						<tr>
							<td><label for="clave">link</label></td>
