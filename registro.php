...
<?php 
    ...
    {?>
        <script type="text/javascript">
            alert("Clave o Correo errado intente nuevamente");
        </script>
    <?php
    }
...
{?>
    <script type="text/javascript">
        alert("El correo o el alias ya esta en uso");
    </script>
<?php    
} ?>
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<div id="wrapper">
		...
		<div id="wrappermiddle">
			...
			<div align="center">
				<form id="formulario" name="f1"	method="post" action="ingreso1.php">
					<table>
						<tr>
						...
						<tr>
							<td><label for="correo">Correo:</label></td>
			  					<td><input type="text" name="correo" id="mail"></td>
						</tr>
						<tr>
							<td><label for="clave">Clave:</label></td>
			  					<td><input type="password" name="clave" id="password1"></td>
						</tr>
						<tr>
							<td><label for="clave">Repita clave:</label></td>
			  					<td><input type="password" name="clave" id="password2"></td>
						</tr>
					</table>		 	
			 	
			  	<input type="button" name="button" value="Registar" onclick="validar()">
			</form>
			<br>
		...
		<script type="text/javascript">
			function validar() {
				...
				else if (!exp1.test(document.getElementById('mail').value)) {
					error+= "debes colocar un formato valido de email \n"
				...
				{
					error +="no debe dejar el alias vacio\n"
					document.getElementById('alias').style.borderColor='#F00'
				}
